...
#ifndef TUSA_ANDROID_AVATARS_ON_MAP_BIG_ZOOM_SHADER_H
#define TUSA_ANDROID_AVATARS_ON_MAP_BIG_ZOOM_SHADER_H

#include <GLES2/gl2.h>
#include "shader/shader.h"

class AvatarsOnMapBigZoomShader: public Shader {
public:
    AvatarsOnMapBigZoomShader(AAssetManager* assetManager, const char* vertexShaderName, const char* fragmentShaderName);
    ...
    GLint getPointOnMap() const { return u_pointOnMap; }
    GLint getPointOnMapPrevious() const { return u_pointOnMapPrevious; }
...
#endif //TUSA_ANDROID_AVATARS_ON_MAP_BIG_ZOOM_SHADER_H
